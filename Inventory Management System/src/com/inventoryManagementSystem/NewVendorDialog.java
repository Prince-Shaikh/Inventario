...
public class NewVendorDialog extends JDialog {
	...
	public NewVendorDialog() {
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewVendor.setForeground(Color.WHITE);
			lblNewVendor.setFont(new Font("Montserrat", Font.BOLD, 30));
			lblNewVendor.setBounds(113, 23, 205, 31);
			contentPanel.add(lblNewVendor);
		}
		{
		...
		}
		{
			...
			textFieldID.setText("" + (Vendor.getidCount()+1));
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if(name.length()!= 0) {
							App.vendors.add(new Vendor(name,address,phoneNumber));
						}else {
